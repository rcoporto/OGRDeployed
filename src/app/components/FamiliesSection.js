          ...
          />
            <div class="grid md:grid-cols-3 gap-8 mx-20">
                <div class="my-32 mx-20 z-10">                       
                    ...
                    <p class="text-lg font-normal font-lora text-gray-60 lg:text-xl">Support the registry and its cause by donating to the following bank account.</p>
                ...
                <div class="w-full max-w-sm p-4 my-8 bg-white border border-gray-200 rounded-xl shadow sm:p-8 z-10">
                    ...
                    <div class="flow-root">
                            ...
                            <h6 class="text-sm font-medium text-bluegreen-80">or</h6>
                            </div>

                            <div>
                                <button type="button" class="text-bluegreen-80 bg-white hover:bg-gray-100 border border-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center me-2 mb-2">
                                ...
                                <button type="button" class="text-white bg-[#050708] hover:bg-[#050708]/80 focus:ring-4 focus:outline-none focus:ring-[#050708]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:hover:bg-[#050708]/40 me-2 mb-2">
                ...
                <div class="my-28 ml-6 z-10">
                    ...
                    {/* <p class="text-lg font-normal font-lora text-gray-60 lg:text-xl mt-6">QR Code for Donation</p> */}
                    <span class="bg-bluegreen-1 text-bluegreen-80 text-sm font-medium font-lora mt-6 inline-flex items-center px-3.5 py-2.5 rounded-lg border border-bluegreen-60">
                    <svg class="w-4 h-4 me-1.5 text-bluegreen-90" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
