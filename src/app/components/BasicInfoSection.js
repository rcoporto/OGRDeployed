...
<a href="https://retina-international.org/irds/" target="_blank" class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-screen-lg hover:bg-gray-100 z-10 bg-blend-screen backdrop-blur-lg transition-all duration-300 cursor-pointer filter grayscale hover:grayscale-0">
...
<a href="https://oculargenomics.meei.harvard.edu/" target="_blank" class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-screen-lg hover:bg-gray-100 z-10 bg-blend-screen backdrop-blur-lg transition-all duration-300 cursor-pointer filter grayscale hover:grayscale-0">
